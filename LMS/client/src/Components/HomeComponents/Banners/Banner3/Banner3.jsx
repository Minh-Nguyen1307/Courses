  ...
  return (
    <div className="h-[800px] mx-4 md:mx-10 flex justify-between items-center flex-col md:flex-row">
      ...
      <div className="w-full md:w-2/5 p-4 relative h-[600px] flex justify-center items-center">
        <div className="w-[600px] h-[600px] flex justify-center items-center hover:scale-105 transition-transform duration-300">
          <img
            src="banner33.png"
            alt="Banner Image 33"
            className="w-[700px] absolute transition-transform duration-300"
          />
          <img
            src="banner3.png"
            alt="Banner Image 3"
            className="w-96 absolute rounded-full transition-transform duration-300"
          />
        </div>
        <img
          src="banner31.png"
